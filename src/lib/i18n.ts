...
const translations = {
  ...
  "finder.all_routes": { pt: "Todas as datas - 2026", en: "All dates - 2026", fr: "Toutes les dates - 2026", de: "Alle Termine - 2026" },
  ...
  "reg.s1_text": { pt: "O presente regulamento define as condições de funcionamento, responsabilidades e normas gerais de TRANSPORTES CARLOS & CÉSAR, que opera entre Portugal e o Luxemburgo.", en: "These regulations define the operating conditions, responsibilities and general rules of TRANSPORTES CARLOS & CÉSAR, operating between Portugal and Luxembourg.", fr: "Le présent règlement définit les conditions de fonctionnement, les responsabilités et les normes générales de TRANSPORTES CARLOS & CÉSAR, opérant entre le Portugal et le Luxembourg.", de: "Diese Verordnung definiert die Betriebsbedingungen, Verantwortlichkeiten und allgemeinen Regeln von TRANSPORTES CARLOS & CÉSAR, die zwischen Portugal und Luxemburg operieren." },
  "reg.s2_title": { pt: "Agendamentos de Recolhas", en: "Pickup Scheduling", fr: "Planification des Enlèvements", de: "Abholtermine" },
  "reg.s2_a": { pt: "As recolhas devem ser agendadas com o máximo de antecedência possível.", en: "Pickups must be scheduled as far in advance as possible.", fr: "Les enlèvements doivent être planifiés le plus tôt possible.", de: "Abholungen müssen so früh wie möglich geplant werden." },
  "reg.s2_b": { pt: "O agendamento pode ser feito por telefone, preferencialmente por WhatsApp.", en: "Scheduling can be done by phone, preferably via WhatsApp.", fr: "La planification peut se faire par téléphone, de préférence via WhatsApp.", de: "Die Terminplanung kann telefonisch erfolgen, vorzugsweise über WhatsApp." },
  "reg.s2_c": { pt: "Os dados fornecidos (nome, contacto, morada, volumes, observações) devem ser corretos e atualizados.", en: "The information provided (name, contact, address, volumes, notes) must be correct and up to date.", fr: "Les informations fournies (nom, contact, adresse, volumes, observations) doivent être correctes et à jour.", de: "Die angegebenen Daten (Name, Kontakt, Adresse, Volumen, Anmerkungen) müssen korrekt und aktuell sein." },
  "reg.s3_title": { pt: "Embalamento e Responsabilidade do Cliente", en: "Packaging and Customer Responsibility", fr: "Emballage et Responsabilité du Client", de: "Verpackung und Kundenverantwortung" },
  "reg.s3_a": { pt: "A mercadoria deve estar devidamente embalada e identificada com o nome, morada e contacto do remetente e do destinatário.", en: "Goods must be properly packaged and labeled with the name, address and contact of sender and recipient.", fr: "La marchandise doit être correctement emballée et identifiée avec le nom, l'adresse et le contact de l'expéditeur et du destinataire.", de: "Die Ware muss ordnungsgemäß verpackt und mit Name, Adresse und Kontakt von Absender und Empfänger gekennzeichnet sein." },
  "reg.s3_b": { pt: "O cliente é responsável pela integridade da embalagem. Não nos responsabilizamos por danos em artigos mal embalados.", en: "The customer is responsible for packaging integrity. We are not liable for damage to poorly packaged items.", fr: "Le client est responsable de l'intégrité de l'emballage. Nous ne sommes pas responsables des dommages aux articles mal emballés.", de: "Der Kunde ist für die Unversehrtheit der Verpackung verantwortlich. Wir haften nicht für Schäden an schlecht verpackten Artikeln." },
  "reg.s3_c": { pt: "Alimentos congelados devem ser transportados em geleiras ou caixas térmicas adequadas.", en: "Frozen food must be transported in suitable coolers or thermal boxes.", fr: "Les aliments surgelés doivent être transportés dans des glacières ou boîtes thermiques adaptées.", de: "Tiefkühlkost muss in geeigneten Kühltaschen oder Thermoboxen transportiert werden." },
  "reg.s4_title": { pt: "Formas de Pagamento", en: "Payment Methods", fr: "Modes de Paiement", de: "Zahlungsmethoden" },
  "reg.s4_a": { pt: "O pagamento do serviço pode ser feito em numerário e multibanco quando disponível (nem todas as carrinhas possuem terminais).", en: "Payment can be made in cash or by card when available (not all vans have terminals).", fr: "Le paiement peut être effectué en espèces ou par carte lorsque disponible (tous les véhicules ne disposent pas de terminaux).", de: "Die Zahlung kann bar oder per Karte erfolgen, wenn verfügbar (nicht alle Fahrzeuge haben Terminals)." },
  "reg.s4_b": { pt: "O valor deve ser pago na recolha ou na entrega, conforme acordado no momento da reserva.", en: "Payment is due at pickup or delivery, as agreed at the time of booking.", fr: "Le paiement est dû à l'enlèvement ou à la livraison, selon l'accord lors de la réservation.", de: "Die Zahlung ist bei Abholung oder Lieferung fällig, wie bei der Buchung vereinbart." },
  "reg.s4_c": { pt: "Em caso de não pagamento, a encomenda poderá ficar retida até à regularização.", en: "In case of non-payment, the shipment may be held until payment is settled.", fr: "En cas de non-paiement, l'envoi pourra être retenu jusqu'à régularisation.", de: "Bei Nichtzahlung kann die Sendung bis zur Begleichung einbehalten werden." },
  "reg.s5_title": { pt: "Cancelamentos e Alterações", en: "Cancellations and Changes", fr: "Annulations et Modifications", de: "Stornierungen und Änderungen" },
  "reg.s5_a": { pt: "O cliente pode cancelar ou alterar uma recolha sem custos, desde que comunicado com o máximo de antecedência possível.", en: "The customer may cancel or modify a pickup at no cost, provided notice is given as early as possible.", fr: "Le client peut annuler ou modifier un enlèvement sans frais, à condition de prévenir le plus tôt possible.", de: "Der Kunde kann eine Abholung kostenlos stornieren oder ändern, sofern dies so früh wie möglich mitgeteilt wird." },
  "reg.s5_b": { pt: "Cancelamentos fora deste prazo poderão implicar custos administrativos.", en: "Late cancellations may incur administrative fees.", fr: "Les annulations tardives peuvent entraîner des frais administratifs.", de: "Verspätete Stornierungen können Verwaltungsgebühren nach sich ziehen." },
  "reg.s6_title": { pt: "Transporte e Entregas", en: "Transport and Deliveries", fr: "Transport et Livraisons", de: "Transport und Lieferungen" },
  "reg.s6_a": { pt: "Os prazos de entrega variam conforme o serviço e serão indicados no momento da recolha.", en: "Delivery times vary by service and will be indicated at pickup.", fr: "Les délais de livraison varient selon le service et seront indiqués lors de l'enlèvement.", de: "Die Lieferzeiten variieren je nach Service und werden bei der Abholung angegeben." },
  "reg.s6_b": { pt: "Os motoristas não estão autorizados a abrir, montar, desmontar ou instalar qualquer tipo de mercadoria.", en: "Drivers are not authorized to open, assemble, disassemble or install any goods.", fr: "Les chauffeurs ne sont pas autorisés à ouvrir, monter, démonter ou installer des marchandises.", de: "Fahrer sind nicht befugt, Waren zu öffnen, zusammenzubauen, zu demontieren oder zu installieren." },
  "reg.s6_c": { pt: "Os motoristas não estão autorizados a entrar em casas, subir escadas de prédios ou transportar mercadoria até divisões específicas. A entrega é feita à porta do prédio, moradia ou do local indicado.", en: "Drivers are not authorized to enter homes, climb stairs or carry goods to specific rooms. Delivery is made at the building entrance or indicated location.", fr: "Les chauffeurs ne sont pas autorisés à entrer dans les maisons, monter des escaliers ou transporter des marchandises dans des pièces spécifiques. La livraison se fait à l'entrée de l'immeuble ou au lieu indiqué.", de: "Fahrer sind nicht befugt, Häuser zu betreten, Treppen zu steigen oder Waren in bestimmte Räume zu bringen. Die Lieferung erfolgt am Gebäudeeingang oder am angegebenen Ort." },
  "reg.s6_d": { pt: "Em caso de ausência do destinatário na morada indicada, dados incompletos ou se o destinatário não atender chamadas telefónicas, a mercadoria poderá ficar no armazém para recolha ou até ser encontrada uma nova data de entrega.", en: "If the recipient is absent, data is incomplete, or calls are unanswered, goods may remain in the warehouse for collection or until a new delivery date is found.", fr: "En cas d'absence du destinataire, de données incomplètes ou d'appels sans réponse, la marchandise pourra rester en entrepôt pour retrait ou jusqu'à une nouvelle date de livraison.", de: "Bei Abwesenheit des Empfängers, unvollständigen Daten oder unbeantworteten Anrufen kann die Ware im Lager zur Abholung verbleiben oder bis ein neuer Liefertermin gefunden wird." },
  "reg.s7_title": { pt: "Mercadorias Proibidas", en: "Prohibited Goods", fr: "Marchandises Interdites", de: "Verbotene Waren" },
  "reg.s7_intro": { pt: "Não transportamos:", en: "We do not transport:", fr: "Nous ne transportons pas :", de: "Wir transportieren nicht:" },
  "reg.s7_a": { pt: "Substâncias ilícitas ou perigosas", en: "Illicit or dangerous substances", fr: "Substances illicites ou dangereuses", de: "Illegale oder gefährliche Substanzen" },
  "reg.s7_b": { pt: "Armas de fogo ou munições", en: "Firearms or ammunition", fr: "Armes à feu ou munitions", de: "Schusswaffen oder Munition" },
  "reg.s7_c": { pt: "Animais vivos", en: "Live animals", fr: "Animaux vivants", de: "Lebende Tiere" },
  "reg.s7_d": { pt: "Dinheiro em numerário ou objetos de elevado valor não declarados (ex: ouro, relógios de luxo, etc)", en: "Cash or undeclared high-value items (e.g., gold, luxury watches)", fr: "Argent liquide ou objets de grande valeur non déclarés (ex : or, montres de luxe)", de: "Bargeld oder nicht deklarierte Wertgegenstände (z.B. Gold, Luxusuhren)" },
  "reg.s7_e": { pt: "Produtos inflamáveis, explosivos ou corrosivos", en: "Flammable, explosive or corrosive products", fr: "Produits inflammables, explosifs ou corrosifs", de: "Brennbare, explosive oder ätzende Produkte" },
  "reg.s7_f": { pt: "Baterias de lítio soltas (fora de equipamento)", en: "Loose lithium batteries (outside equipment)", fr: "Batteries au lithium en vrac (hors équipement)", de: "Lose Lithiumbatterien (außerhalb von Geräten)" },
  "reg.s7_g": { pt: "Equipamentos eletrónicos mal acondicionados", en: "Poorly packaged electronic equipment", fr: "Équipements électroniques mal conditionnés", de: "Schlecht verpackte Elektronikgeräte" },
  "reg.s7_h": { pt: "Vidros soltos ou peças frágeis sem proteção adequada", en: "Loose glass or fragile items without adequate protection", fr: "Verres en vrac ou pièces fragiles sans protection adéquate", de: "Loses Glas oder zerbrechliche Teile ohne ausreichenden Schutz" },
  "reg.s8_title": { pt: "Reclamações", en: "Complaints", fr: "Réclamations", de: "Beschwerden" },
  "reg.s8_a": { pt: "Reclamações ou danos devem ser reportados ao motorista no ato de entrega.", en: "Complaints or damages must be reported to the driver at the time of delivery.", fr: "Les réclamations ou dommages doivent être signalés au chauffeur lors de la livraison.", de: "Beschwerden oder Schäden müssen dem Fahrer bei der Lieferung gemeldet werden." },
  "reg.s8_b": { pt: "Analisamos cada situação com o máximo de rigor e profissionalismo.", en: "We analyze each situation with the utmost rigor and professionalism.", fr: "Nous analysons chaque situation avec le plus grand professionnalisme.", de: "Wir analysieren jede Situation mit höchster Sorgfalt und Professionalität." },
  "reg.s8_c": { pt: "Fotografias ou vídeos podem ser solicitados como prova de danos.", en: "Photos or videos may be requested as proof of damage.", fr: "Des photos ou vidéos peuvent être demandées comme preuve de dommages.", de: "Fotos oder Videos können als Schadensbeweis angefordert werden." },
  "reg.s9_title": { pt: "Armazéns", en: "Warehouses", fr: "Entrepôts", de: "Lager" },
  "reg.s9_text": { pt: "A empresa dispõe de armazéns em Portugal, Luxemburgo e França (zona de fronteira). Os horários e contactos estão disponíveis no nosso site.", en: "The company has warehouses in Portugal, Luxembourg and France (border area). Schedules and contacts are available on our website.", fr: "L'entreprise dispose d'entrepôts au Portugal, au Luxembourg et en France (zone frontalière). Les horaires et contacts sont disponibles sur notre site.", de: "Das Unternehmen verfügt über Lager in Portugal, Luxemburg und Frankreich (Grenzgebiet). Öffnungszeiten und Kontakte sind auf unserer Website verfügbar." },
  "reg.s10_title": { pt: "Confidencialidade e Dados Pessoais", en: "Confidentiality and Personal Data", fr: "Confidentialité et Données Personnelles", de: "Vertraulichkeit und personenbezogene Daten" },
  "reg.s10_a": { pt: "Os dados dos clientes são utilizados apenas para fins logísticos e de comunicação.", en: "Customer data is used only for logistics and communication purposes.", fr: "Les données des clients sont utilisées uniquement à des fins logistiques et de communication.", de: "Kundendaten werden nur für Logistik- und Kommunikationszwecke verwendet." },
  "reg.s10_b": { pt: "Comprometemo-nos a não partilhar dados com terceiros, salvo obrigação legal.", en: "We commit to not sharing data with third parties, except by legal obligation.", fr: "Nous nous engageons à ne pas partager les données avec des tiers, sauf obligation légale.", de: "Wir verpflichten uns, Daten nicht an Dritte weiterzugeben, außer bei gesetzlicher Verpflichtung." },
  "reg.s10_c": { pt: "Estamos em conformidade com o Regulamento Geral sobre a Proteção de Dados (RGPD).", en: "We comply with the General Data Protection Regulation (GDPR).", fr: "Nous sommes en conformité avec le Règlement Général sur la Protection des Données (RGPD).", de: "Wir sind konform mit der Datenschutz-Grundverordnung (DSGVO)." },
  "reg.s11_title": { pt: "Disposições Finais", en: "Final Provisions", fr: "Dispositions Finales", de: "Schlussbestimmungen" },
  "reg.s11_a": { pt: "Os TRANSPORTES CARLOS & CÉSAR reservam-se ao direito de alterar este regulamento a qualquer momento, sem aviso prévio, sendo as alterações publicadas nesta página.", en: "TRANSPORTES CARLOS & CÉSAR reserves the right to modify these regulations at any time without prior notice, with changes published on this page.", fr: "TRANSPORTES CARLOS & CÉSAR se réserve le droit de modifier ce règlement à tout moment sans préavis, les modifications étant publiées sur cette page.", de: "TRANSPORTES CARLOS & CÉSAR behält sich das Recht vor, diese Verordnung jederzeit ohne Vorankündigung zu ändern, wobei Änderungen auf dieser Seite veröffentlicht werden." },
  "reg.s11_b": { pt: "O uso dos nossos serviços implica a aceitação do regulamento em vigor.", en: "The use of our services implies acceptance of the regulations in force.", fr: "L'utilisation de nos services implique l'acceptation du règlement en vigueur.", de: "Die Nutzung unserer Dienste impliziert die Akzeptanz der geltenden Verordnung." },

  // Congelados info page
  "cong.title": { pt: "Serviço de Congelados", en: "Frozen Goods Service", fr: "Service Surgelés", de: "Tiefkühlservice" },
  "cong.intro": { pt: "Realizamos transporte de mercadoria congelada entre Portugal e o Luxemburgo, em camião frigorífico com todas as condições térmicas necessárias para garantir que a sua mercadoria chega ao destino em perfeitas condições.", en: "We transport frozen goods between Portugal and Luxembourg in a refrigerated truck with all the necessary thermal conditions to ensure your goods arrive in perfect condition.", fr: "Nous transportons des marchandises surgelées entre le Portugal et le Luxembourg dans un camion frigorifique avec toutes les conditions thermiques nécessaires.", de: "Wir transportieren Tiefkühlware zwischen Portugal und Luxemburg in einem Kühlwagen mit allen notwendigen thermischen Bedingungen." },
  "cong.schedule_title": { pt: "Agende com antecedência", en: "Schedule in advance", fr: "Planifiez à l'avance", de: "Planen Sie im Voraus" },
  "cong.schedule_desc": { pt: "O envio de congelados deve ser agendado com o máximo de antecedência possível, por telefone ou WhatsApp. Assim garantimos espaço no camião frigorífico e o melhor serviço para a sua mercadoria.", en: "Frozen shipments must be scheduled as far in advance as possible, by phone or WhatsApp. This ensures space in the refrigerated truck and the best service for your goods.", fr: "Les envois surgelés doivent être planifiés le plus tôt possible, par téléphone ou WhatsApp. Cela garantit de l'espace dans le camion et le meilleur service.", de: "Tiefkühlsendungen müssen so früh wie möglich per Telefon oder WhatsApp geplant werden, um Platz im Kühlwagen und den besten Service zu gewährleisten." },
  "cong.packaging_title": { pt: "Embalamento adequado", en: "Proper packaging", fr: "Emballage approprié", de: "Geeignete Verpackung" },
  "cong.packaging_desc": { pt: "A mercadoria congelada deve estar devidamente acondicionada dentro de embalagens térmicas adequadas, como caixas de esferovite (ferrovite), arcas térmicas ou sacos térmicos. O cliente é responsável pela correta embalagem dos seus produtos.", en: "Frozen goods must be properly packed in suitable thermal packaging, such as polystyrene (styrofoam) boxes, thermal coolers or thermal bags. The customer is responsible for proper packaging.", fr: "Les marchandises surgelées doivent être correctement conditionnées dans des emballages thermiques adaptés : boîtes en polystyrène, glacières thermiques ou sacs thermiques. Le client est responsable du bon emballage.", de: "Tiefkühlware muss in geeigneten Thermoverpackungen wie Styroporboxen, Kühlboxen oder Thermobeuteln verpackt sein. Der Kunde ist für die korrekte Verpackung verantwortlich." },
  "cong.transport_title": { pt: "Transporte frigorífico", en: "Refrigerated transport", fr: "Transport frigorifique", de: "Kühltransport" },
  "cong.transport_desc": { pt: "O transporte é realizado em camião frigorífico, com temperatura controlada durante todo o trajeto. A mercadoria viaja em condições térmicas adequadas para chegar ao destino em perfeitas condições de conservação.", en: "Transport is carried out in a refrigerated truck with controlled temperature throughout the journey. Goods travel in proper thermal conditions to arrive at their destination in perfect preservation.", fr: "Le transport est effectué en camion frigorifique, avec une température contrôlée tout au long du trajet. Les marchandises voyagent dans des conditions thermiques optimales.", de: "Der Transport erfolgt im Kühlwagen mit kontrollierter Temperatur während der gesamten Fahrt. Die Waren reisen unter optimalen Bedingungen." },
  "cong.pickup_title": { pt: "Levantamento no destino", en: "Pickup at destination", fr: "Retrait à destination", de: "Abholung am Ziel" },
  "cong.pickup_desc": { pt: "A mercadoria congelada deve ser levantada no destino entre as 16:00 e as 18:30 do dia de chegada. É fundamental respeitar este horário para garantir a qualidade e conservação dos produtos.", en: "Frozen goods must be picked up at the destination between 4:00 PM and 6:30 PM on the day of arrival. It is essential to respect this schedule to ensure product quality and preservation.", fr: "Les marchandises surgelées doivent être retirées à destination entre 16h00 et 18h30 le jour d'arrivée. Il est essentiel de respecter cet horaire pour garantir la qualité des produits.", de: "Tiefkühlware muss am Zielort zwischen 16:00 und 18:30 Uhr am Ankunftstag abgeholt werden. Die Einhaltung dieses Zeitplans ist entscheidend für die Produktqualität." },
} as const;
